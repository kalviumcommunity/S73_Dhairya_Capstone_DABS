...
export default function AdminDashboard() {
  ...
  const fetchPendingDoctors = async () => {
    ...
    try {
      ...
      console.log("Fetched pending doctors:", doctors);
                ...
                {loading ? (
                  ...
                  pendingDoctors.map((doc) => (
                    <div key={doc._id} style={{ border: '1px solid #999', marginBottom: '15px', padding: '15px', backgroundColor: '#f0f0f0', lineHeight: '1.6' }}>
                      ...
                      <p><strong>Degree:</strong> {doc.degree || 'N/A'} | <strong>Experience:</strong> {doc.experience || '0'} years</p>
                      <p><strong>Email:</strong> {doc.email}</p>
                      <p><strong>About:</strong> {doc.about || 'No description provided.'}</p>
                      <p><strong>Address:</strong> {doc.address?.line1 || 'N/A'}</p>
